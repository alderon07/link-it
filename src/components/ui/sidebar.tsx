  ...
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        pixel:
          "rounded-none border-2 border-transparent font-bold transition-all duration-150 hover:bg-pixel-pink/20 hover:border-foreground hover:text-pixel-pink hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[3px_3px_0_0_var(--shadow-color)] active:translate-x-0 active:translate-y-0 active:shadow-none data-[active=true]:bg-pixel-pink data-[active=true]:border-foreground data-[active=true]:text-foreground data-[active=true]:font-black data-[active=true]:shadow-[3px_3px_0_0_var(--shadow-color)]",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
